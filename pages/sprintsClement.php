	 	...
	 	<div id="page-wrapper">
	            <div class="row">
	                <div class="col-lg-12" style="text-align:center">
	                    ...
	                    <div class="row">
	                <div class="col-lg-12">
	                    <p style="text-align:right"> Temps Total : 133 heures</p>
																...
																<!-- Sprint 8 -->
																															<div class="panel panel-default">
																																		...
																																		<div id="sprint8" class="panel-collapse collapse">
																																				...
																																				<p style="text-align:right"> Temps Sprint : 32 heures</p>
																																				<div class="panel panel-default">
																																						<div class="panel-heading">
																																								Relev&eacute; d'activit&eacute;s
																																						</div>
																																										...
																																										<table class="table table-striped table-bordered table-hover">
																																												...
																																												<tbody>
																																													<tr>
																																														<td>06/03/2017</td>
																																														<td>3 heures</td>
																																														<td>4.1.2 Un gestionnaire peut modérer les offres (Les accepter ou les refuser).</td>
																																													</tr>
																																													<tr>
																																														<td>04/03/2017</td>
																																														<td>1 heure</td>
																																													...
																																													<tr>
																																														<td>27/02/2017</td>
																																														<td>2 heures</td>
																																														<td>Uniformisation du header et de la partie authentification afin de gérer les différents type d'utilisateurs sur le site</td>
																																													</tr>
																																													<tr>
																																														<td>23/02/2017</td>
																																														<td>1 heure</td>
																																														<td>Modification du header afin de gérer les différents type d'utilisateurs sur le site</td>
																																													</tr>
																																													<tr>
																																														<td>20/02/2017</td>
																																														<td>1 heure</td>
																																																											...
																																																											<table class="table table-striped table-bordered table-hover">
																																																													...
																																																													<tbody>
																																																														...
																																																														<tr>
																																																															<td>01/02/2017</td>
																																																															<td>2 heures</td>
																																																															<td>2.2 Modification de l'html pour les offres à venir, en attente de validation et passées.</td>
																																																														</tr>
																																											...
																																											<table class="table table-striped table-bordered table-hover">
																																													...
																																													<tbody>
																																														...
																																														<tr>
																																															<td>25/01/2017</td>
																																															<td>1 heure </td>
																																															<td>1.1.7 Finalisation de la feuille de style et du "format" concernant les dates de disponibilités.</td>
																																														</tr>
																																														<tr>
																																															<td>24/01/2017</td>
																																															<td>2 heures </td>
																																														...
																																														<tr>
																																															<td>17/01/2017</td>
																																															<td>1 heure </td>
																																															<td>1. - Uniformisation du formulaire (design).</td>
																																														</tr>
																																														<tr>
																																															<td>17/01/2017</td>
																																															<td>1 heure 30</td>
																																															<td>2.2.1 - Réalisation de la page HTML qui permet au référent de consulter ses offres.</td>
																																														</tr>
																																														<tr>
																																															<td>17/01/2017</td>
																																															<td>1 heure 30</td>
																																															<td>2.1 & 2.2 - Création des maquettes pour les CU : "Création d'une offre" & "Consultation des offres"</td>
																																														</tr>
	...
	<!-- Sprint 5 -->
																<div class="panel panel-default">
																			...
																			<div id="sprint5" class="panel-collapse collapse">
																					...
																					<p style="text-align:right"> Temps Sprint : 15 heure</p>
																					<div class="panel panel-default">
																							<div class="panel-heading">
																									Relev&eacute; d'activit&eacute;s
																							</div>
																											...
																											<table class="table table-striped table-bordered table-hover">
																													...
																													<tbody>
																														<tr>
																															<td>13/01/2017</td>
																															<td>3 heures</td>
																															<td>Modifications du controleur pour effectuer l'enregistrer du CV sur le serveur. Modifications du style des pages. Modifications des types dates pour l'enregistrement </td>
																														</tr>
																														<tr>
																															<td>12/01/2017</td>
																															<td>1 heure</td>
																														...
																														<tr>
																															<td>19/12/2016</td>
																															<td>1 heure</td>
																															<td>Tests de modification du style (Header et onglets)</td>
																														</tr>
																														<tr>
																															<td>19/12/2016</td>
																															<td>2 heures</td>
																											...
																											<table class="table table-striped table-bordered table-hover">
																													...
																													<tbody>
																														...
																														<tr>
																															<td>13/12/2016</td>
																															<td>2 heures</td>
																															<td>D&eacute;veloppement du service permettant d'ajouter les informations personnelles d'un &eacute;tudiant</td>
																														</tr>
																														<tr>
																															<td>09/12/2016</td>
																															<td>2 heures</td>
																															<td>Uniformisation des différentes parties des formulaires créés (infos perso,divers,souhait..) et réalisation du header</td>
																														</tr>
																														<tr>
																															<td>06/12/2016</td>
																															<td>1 heures</td>
	                                                    ...
	                                                    <table class="table table-striped table-bordered table-hover">
	                                                        ...
	                                                        <tbody>
	                                                            ...
	                                                            <tr>
	                                                                <td>15/11/2016</td>
	                                                                <td>2 heure</td>
	                                                                <td>Réalisation du schéma hiérarchique</td>
	                                                            </tr>
	                                                            <tr>
	                                                                <td>14/11/2016</td>
	                                                                <td>2 heure</td>
	                                                                <td>Modification des CU et réalisation du diagramme d'activité "Deposer une offre"</td>
	                                                            </tr>
	                                                            <tr>
	                                                                <td>08/11/2016</td>
	                                                                <td>2 heure</td>
