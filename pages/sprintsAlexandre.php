                ...
                <div class="panel-group" id="accordion">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="sprint8" class="panel-collapse collapse">
                      ...
                      <p style="text-align:right"> Temps Sprint : 23 heures</p>
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          Relev&eacute; d'activit&eacute;s
                        </div>
                          ...
                          <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                              ...
                              <tr>
                                  <td>03/03/2017</td>
                                  <td>2 heures</td>
                                  <td>1.1.9 Recherche redirection SSO-CAS</td>
                                </tr>
                                <tr>
                                  <td>28/02/2017</td>
                                  <td>1 heure</td>
                                  <td>1.1.9 Recherche sur la deconnexion SSO-CAS</td>
                                </tr>
                                <tr>
                                  <td>27/02/2017</td>
                                  <td>2 heures</td>
                          ...
                          <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                              ...
                              <tr>
                                  <td>09/02/2017</td>
                                  <td>1 heure</td>
                                  <td>1.1.10 Debut de resolution de bug de l'enregistrement du CV sur le serveur</td>
                                </tr>
                              <tr>
                                  <td>08/02/2017</td>
                                  <td>2 heures</td>
                                  <td>1.2.1 Finalisation de la page de profil</td>
                                </tr>
                                <tr>
                                  <td>07/02/2017</td>
                                  <td>5 heures</td>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td>13/12/2016</td>
                                  <td>1 heure</td>
                                  <td>D&eacute;veloppement du service et du repository permettant d'ajouter les informations diverses d'un &eacute;tudiant</td>
                                </tr>
                                <tr>
                                  <td>06/12/2016</td>
                                  <td>2.5 heure</td>
                        ...
                        <div class="panel-body">
                          <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                              ...
                              <tbody>
                                <tr>
                                  <td>24/11/2016 - 27/11/2016</td>
                                  <td>4 heures</td>
                                  <td>Modification du dossier d'expression des besoins</td>
                                  <tr>
                                    <td>30/11/2016</td>
                                    <td> 1 heure</td>
                                    <td>Mise en place du template Thymeleaf sur le siteweb</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                              ...
                              <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                  <tr>
                                    <td>16/11/2016</td>
                                    <td>5h</td>
                                    <td>Modification du site pour afficher les informations de la BDD </td>
                                  </tr>
                                  <tr>
                                    <td>03/11/2016 - 16/11/2016</td>
                                    <td>4h</td>
                                    <td>Configuration Jenkins , Tomcat, Spring boot pour le site</td>
                                  </tr>
                                  <tr>
